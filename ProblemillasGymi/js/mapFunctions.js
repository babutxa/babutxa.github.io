...
function createMarkerWithCustomIcon(school, scale, color1, opacity1, color2, opacity2) {
    ...
    const path1 = paper.path(pathData1);
    path1.trasform('s${scale}');
    
    const path2 = paper.path(pathData2);
    path2.trasform('s${scale}');
